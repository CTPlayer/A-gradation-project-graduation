	...
	<div class="left_menu"	>
      ...
      <li>
		...
		<div class="m-right" style="background-color: #f6f6f6">
			...
			<br>
			<div class="main">
					<form class="form-horizontal" action="../view/addItem.do" method="post" id="f">
  						<div class="form-group">
  						<strong><span id="error1" style="color: red;"></span></strong>
    					<label for="inputEmail3" class="col-sm-2 control-label">项目名称</label>
    					<div class="col-sm-10">
      						<input type="text" class="form-control" id="mysubject" name="itemname">
    					</div>
  						</div>
  						<div class="form-group">
  						<strong><span id="error2" style="color: red;"></span></strong>
   						<label for="inputPassword3" class="col-sm-2 control-label">立项时间</label>
    					<div class="col-sm-10">
      						<input type="date" class="form-control" id="mytype" name="itemtimes">
    					</div>
  						</div>
  						<div class="form-group">
  						<strong><span id="error3" style="color: red;"></span></strong>
    					<label for="inputEmail3" class="col-sm-2 control-label">资助单位</label>
    					<div class="col-sm-10">
      						<input type="text" class="form-control" id="myproperty" name="support">
    					</div>
  						</div>
  						<div class="form-group">
    					<label for="inputEmail3" class="col-sm-2 control-label">备注</label>
    					<div class="col-sm-10">
      						<input type="text" class="form-control" id="mymajor" name="remark">
    					</div>
  						</div>					
...
<script>
	var array = {"subject":false,"type":false,"property":false};
	$(function(){
	...
	$(function(){
		$("#f").submit(function(){
			if(array.subject&&array.type&&array.property){
				return true;
			}else{
				alert("请验证表单！");
				return false;
