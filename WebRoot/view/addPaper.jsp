	...
	<div class="left_menu"	>
      ...
      <li>
		...
		<div class="m-right" style="background-color: #f6f6f6">
			...
			<br>
			<div class="main">
					<form class="form-horizontal" action="../view/addPaper.do" method="post" id="f">
  						<div class="form-group">
  						<strong><span id="error1" style="color: red;"></span></strong>
    					<label for="inputEmail3" class="col-sm-2 control-label">论文名称</label>
    					<div class="col-sm-10">
      						<input type="text" class="form-control" id="mysubject" name="papername">
    					</div>
  						</div>
  						<div class="form-group">
  						<strong><span id="error2" style="color: red;"></span></strong>
   						<label for="inputPassword3" class="col-sm-2 control-label">刊物名称</label>
    					<div class="col-sm-10">
      						<input type="text" class="form-control" id="mytype" name="publication">
    					</div>
  						</div>
  						<div class="form-group">
  						<strong><span id="error3" style="color: red;"></span></strong>
    					<label for="inputEmail3" class="col-sm-2 control-label">发表时间</label>
    					<div class="col-sm-10">
      						<input type="date" class="form-control" id="myproperty" name="announcetimes">
    					</div>
  						</div>
  						<div class="form-group">
    					...
    					<div class="col-sm-10">
      						<input type="text" class="form-control" id="mymajor" name="level">
    					</div>
  						</div>
  						<div class="form-group">
    					<label for="inputEmail3" class="col-sm-2 control-label">发表人</label>
    					<div class="col-sm-10">
      						<input type="text" class="form-control" id="myremark" name="author">
    					</div>
  						</div>						
